...
class FasteNet_Lite(nn.Module):
    def __init__(self):
        ...
        self.layer6 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, padding=1)
        self.layer7 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, padding=1)
        self.layer8 = nn.MaxPool2d(kernel_size=2)
        self.batch_norm4 = nn.BatchNorm2d(num_features=128)
        self.layer9 = nn.Conv2d(in_channels=128, out_channels=1, kernel_size=3, padding=1)
